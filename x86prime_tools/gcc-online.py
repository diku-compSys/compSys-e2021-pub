...
parser.add_argument('-fno-optimize-sibling-calls', dest='osc', action='store_const',
                    const=True, default=False,
                    help='')
parser.add_argument('-fcf-protection=none', dest='protect', action='store_const',
                    const=True, default=False,
                    help='')
...
os.system("cat "+args.file+" | cpp > "+args.file+"_cpp")

file = open(args.file+"_cpp", 'r')
args.fileCont = file.read()
file.close()

os.system("rm "+args.file+"_cpp")

# x86prime Online location
URL = "http://topps.diku.dk/compsys/gcc.php"
# defining a params dict for the parameters to be sent to the API
DATA = {"filename":args.file, "file":args.fileCont, "Wall":args.Wall, "Wextra":args.Wextra, "Winline":args.Winline, "pedantic":args.pedantic, "osc":args.osc, "protect":args.protect}
